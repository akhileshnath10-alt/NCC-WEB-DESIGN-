  ...
  head: () => ({
    meta: [
      ...
      { title: "NCC College Unit — Discipline, Service, Honour" },
      {
        name: "description",
        content:
          "Official portal of the NCC unit at our college. Activities, notices, gallery and cadet login.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/eea89320-902c-4c6e-9339-3e6b3a668ba7/id-preview-6c92e76d--839b528a-e6ea-4a0d-913d-a78c8337234c.lovable.app-1781430239395.png",
      },
      {
        name: "twitter:image",
        content:
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-4">
        <Link to="/" className="flex items-center gap-3 group">
          ...
          <span className="flex flex-col leading-tight">
            <span className="font-display text-base text-foreground whitespace-pre-line">
              NCC CEMP
            </span>
            <span className="label-eyebrow text-muted-foreground">ARMY WING · ESTD. 2024</span>
          </span>
        </Link>
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 max-w-md text-sm text-primary-foreground/70">
            The National Cadet Corps unit at our college trains young women and men into responsible
            citizens through drill, adventure, and service.
          </p>
        </div>
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            {NAV.map((n) => (
              <li key={n.to}>
                <Link to={n.to} className="hover:text-[color:var(--brass)] transition">
                  {n.label}
                </Link>
              </li>
            ))}
